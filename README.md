...
| `saigai` | 自然災害（大阪・近畿） | `DISCORD_WEBHOOK_URL_SAIGAI` | `max_per_run: 100`（Googleニュースが返す上限とほぼ同じ＝実質上限なし） / `dedup_first_n: 0`（**1話題あたりの件数上限なし**） / `dedup_ignore_words: ["大阪府", "大阪", "近畿", "関西"]` |
